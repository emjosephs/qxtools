...
##makes a kinship matrix using pairwise complete data. input is a matrix where the rows are loci and the columns are individuals or populations and the values are the allele frequency.

make_k_pairwise <- function(mygenos){
